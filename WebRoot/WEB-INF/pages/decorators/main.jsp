...
<html>
<head>
<title><decorator:title default="Wedding" /></title>
...
<meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        ...
        <!-- Sparkline -->
        <script src="${pageContext.request.contextPath }/js/plugins/sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
        <!-- jvectormap -->
        <script src="${pageContext.request.contextPath }/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath }/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
        <!-- fullCalendar -->
        <script src="${pageContext.request.contextPath }/js/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
        <!-- jQuery Knob Chart -->
        <script src="${pageContext.request.contextPath }/js/plugins/jqueryKnob/jquery.knob.js" type="text/javascript"></script>
        <!-- daterangepicker -->
        ...
        <script src="${pageContext.request.contextPath }/js/AdminLTE/dashboard.js" type="text/javascript"></script>   
<decorator:head /> 
</head>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>组件</span> <small class="badge pull-right bg-green">new</small>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                        ...
                        <li>
                            <a href="pages/mailbox.html">
                                <i class="fa fa-envelope"></i> <span>信箱</span>
